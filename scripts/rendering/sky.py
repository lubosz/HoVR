...
for mat in mesh.materials:
	...
	if shader != None:
		...
		#shader.setUniform1f('luminance',g.luminance)
		shader.setUniform1f('turbidity',g.turbidity)
		shader.setUniform1f('reileigh',g.reileigh)
		#shader.setUniform1f('bias',g.bias)
		#shader.setUniform1f('contrast',g.contrast)
		#shader.setUniform1f('lumamount',g.lumamount)
